 ...
 */
class BookReaderGen extends baseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('book, reader', 'required'),
			array('book, reader', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, book, reader', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'reader0' => array(self::BELONGS_TO, 'Reader', 'reader'),
		);
	}
